 ...
 *
 * @author jojam
 * agradecimientos totales a Nikos Kanargias
 */
public class maze411 {
   ...
   public static JFrame mazeFrame;  // The main form of the program
    ...
    public static void main(String[] args) {
        int width  = 693;
        int height = 545;
        mazeFrame = new JFrame("Maze 4.1.1");
...
      * and contains all the functionality of the program.
    ...
    public static class MazePanel extends JPanel {
         ...
         */
        private class Cell {
            int row;   // el número de fila de la celda (fila 0 es la parte superior)
            int col;   // el número de columna de la celda (columna 0 es la izquierda)
            int g;     // el valor de la función g de A algoritmos codiciosos y *
            int h;     // el valor de la función H de un algoritmos codiciosos * y
            int f;     // el valor de la función H de un algoritmos codiciosos * y
            int dist;  // la distancia de la célula a partir de la posición inicial del robot
                       // Es decir, la etiqueta que actualiza el algoritmo de Dijkstra
            Cell prev; // Cada estado corresponde a una célula
                       
						// Y cada estado tiene un predecesor que
        ...
        } // poner fin a la célula clase anidada
      
        /**
         
		* Clase auxiliar que especifica que se ordenarán las células
		* Según su campo 'f'
         */
        ...
        } // terminar CellComparatorByF clase anidada
        ...
        } // y CellComparatorByDist clase anidada
      
        /**
         * Clase que se encarga de los movimientos del ratón, ya que "pintar"
         * obstáculos o mover el robot y / o de destino.
         */
        ...
        private class ActionHandler implements ActionListener {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (cmd.equals("Clear")) {
                    ...
                    timer.stop();
                    // Aquí decidimos si podemos continuar con el
                    // 'Paso a Paso' buscar o no.
                    //  En el caso de DFS, BFS, A * y algoritmos codicioso
                    // Aquí tenemos el segundo paso:
                    // 2. Si OPEN SET = [], y luego terminar. No hay una solución
        ...
        private class AboutBox extends JDialog{
            ...
            public AboutBox(Frame parent, boolean modal){
                ...
                JLabel version = new JLabel("Version: 4.1.1", JLabel.CENTER);
        ...
        private final static String
            msgDrawAndSelect =
                "\"Paint\" obstacles, then click 'Step-by-Step' or 'Animation'",
        ...
        private void initializeGrid(Boolean makeMaze) {                                           
            ...
            try {
                if (!rowsField.getText().isEmpty()){
                    ...
                    JOptionPane.showMessageDialog(this,
                            "The field \"# of rows\" \naccepts only numbers between 5 and 83",
            ...
            if (rows < 5 || rows > 83) {
                JOptionPane.showMessageDialog(this,
                        "The field \"# of rows\" \naccepts values between 5 and 83",
                        "Problem", JOptionPane.ERROR_MESSAGE);
                rows = oldRows;
                return;
            }
        ...
        /**
         * Function executed if the user presses the button "About Maze"
         */
